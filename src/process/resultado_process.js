...
function genPDF() {
    ...
    doc.pipe(fs.createWriteStream(resultPdf[32] + ".pdf"));
    doc
        .font("Times-Roman", 13)
        .moveDown()
        ...
        .text("Teléfono: " + resultPdf[4], 350, 110)
        .moveDown()
        ...
        .moveDown()
        .text("N° Partos: " + resultPdf[36] + " , N° Abortos: " + resultPdf[37] + " , N° Cesareas: " + resultPdf[38],30,200)
        .moveDown()
        ...
        .text("------------CÉLULAS------------", 30, 370)
        .moveDown()
        .text("Endocervicales: " + resultPdf[22] + ",  Metaplásticas: " + resultPdf[23] + ", Endometriales: " + resultPdf[24], 30, 400)
        .moveDown()
        ...
        .moveDown()
        .text("C. Parabasales: " + resultPdf[26] + " ,  C. Intermedias" + resultPdf[27] + " , C. Superficiales: " + resultPdf[28], 30, 540)
        .moveDown()
